...
# ==========================================
# Project 4 - Team Status Dashboard
    ...
    if request.method == 'POST':
        ...
        with conn.cursor() as c:
            ...
            c.execute(
                ...
                (team_name,project,status,message,author,instance_id)
                VALUES(%s,%s,%s,%s,%s,%s)
                ''',
                (
...
DB_HOST=project4-mysql.c87uscy8my2i.us-east-1.rds.amazonaws.com
DB_PORT=3306
DB_USER=admin
